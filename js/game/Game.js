...
import { CONFIG, GAME_STATE } from '../config.js?v=202608210127';
import { Paddle } from '../entities/Paddle.js?v=202608210127';
import { ParticleSystem } from '../systems/Particles.js?v=202608210127';
import { InputManager } from '../systems/Input.js?v=202608210127';
import { CollisionSystem } from '../systems/Collision.js?v=202608210127';
import { AudioManager } from '../systems/Audio.js?v=202608210127';
import { LevelManager } from '../levels/LevelManager.js?v=202608210127';
import { Effects } from '../systems/Effects.js?v=202608210127';
import { Renderer } from '../systems/Renderer.js?v=202608210127';
import { Background } from '../systems/Background.js?v=202608210127';
import { Flow } from './Flow.js?v=202608210127';
import { Combat } from './Combat.js?v=202608210127';
import { Collect } from './Collect.js?v=202608210127';
import { initMenu } from '../systems/Menu.js?v=202608210127';
import { initBosses } from '../systems/Bosses.js?v=202608210127';
import { initPolish } from '../systems/Polish.js?v=202608210127';
import { initArtifact } from '../systems/Artifact.js?v=202608210127';
import { initWalls } from '../systems/Walls.js?v=202608210127';
import { initAchievements } from '../systems/Achievements.js?v=202608210127';
import { initFun } from '../systems/Fun.js?v=202608210127';
import { initPower } from '../systems/Power.js?v=202608210127';
import { initUtukku } from '../systems/Utukku.js?v=202608210127';
import { initEvents } from '../systems/Events.js?v=202608210127';
import { initBiomes } from '../systems/Biomes.js?v=202608210127';
import { initMusic } from '../systems/Music.js?v=202608210127';
import { initRestore } from '../systems/Restore.js?v=202608210127';
import { initVisual } from '../systems/Visual.js?v=202608210127';
import { Enemies } from '../systems/Enemies.js?v=202608210127';
...
export class Game {
  constructor() {
    ...
    initBosses(this);
    initPolish(this);
    initArtifact(this); initWalls(this);
