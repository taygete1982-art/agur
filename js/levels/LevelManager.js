...
import { V2LEVELS } from '../levels_v2/v2levels.js?v=202608210017';
import { Wall } from '../entities/Wall.js?v=202608210017';
import { V2, initV2Loader } from './LevelLoaderV2.js?v=202608210017';
  ...
  loadLevel(n) {
    ...
    for (let r = 0; r < ROWS; r++) for (let x = 0; x < COLS; x++) {
      ...
      if (ch >= 'a' && ch <= 'd') b.color = biomeColor(0, ch.charCodeAt(0)-97);
        ...
        case '#': case 'T': b.setType('steel'); break; this.walls.push(new Wall(offX + x*step, offY + r*(CONFIG.BRICK.HEIGHT+4), CONFIG.BRICK.WIDTH, CONFIG.BRICK.HEIGHT));
